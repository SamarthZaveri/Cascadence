...
# Override the .ini's sqlalchemy.url with the app's own settings, so app and
# migrations never drift out of sync on connection details.
...
# Shared declarative Base — autogenerate diffs against this.
